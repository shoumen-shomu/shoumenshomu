      ...
      <Container>
        <div className="py-5 lg:px-0 ">
          <Flex className={"justify-between"}>
            ...
            {/* Menu Overly start */}
            <div
              className={`lg:hidden fixed top-0 left-0 w-107.5 h-100 bg-[#181A1D] flex flex-col items-center justify-center gap-y-8 transition-all duration-500 ${show ? "translate-y-20" : "-translate-y-full"} `}
            >
